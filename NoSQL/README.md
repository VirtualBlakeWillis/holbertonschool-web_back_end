# Project: NoSQL | Holberton Tulsa, OK, USA Intranet
...
* [The mongo Shell](/rltoken/IBTPKFIwEIANMSJ-EDkP9A "The mongo Shell")
...
Potential issue if documents creation doesn’t work or this error: `Data directory /data/db not found., terminating` ([source](/rltoken/Mpe5zmt_IlIraIzmQtfAIw "source") and [source](/rltoken/omWrxp3WcrtN9SL1Mb-MCg "source"))
